...
argparser.add_argument(
    '-c',
    '--conf',
    default='/home/lucien/Documents/project_ornithoScope_lucienbis/src/config/benchmark_config/best_model.json',
    help='path to configuration file')

argparser.add_argument(
    '-w',
    '--weights',
    default='/home/lucien/Documents/project_ornithoScope_lucienbis/src/data/saved_weights/benchmark_weights/best_model_bestLoss.h5',
